...
const Footer = () => {
  return <div data-scroll data-scroll-section data-scroll-speed=".5"  className="h-screen flex w-fyll bg-whites p-20">
      ...
      <div className="w-1/2 font-foundersgrotesk px-6 py-10 relative">
        ...
        <a href="mailto:soumyaranjanpraharaj04@gmail.com" className="font-neuemontreal text-2xl absolute top-full py-5 flex items-center text-[#7777]">
          &copy; ochi design 2024. <a href="/">Legal Terms</a>
        </a>
      </div>
    </div>;
};
